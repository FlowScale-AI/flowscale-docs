...
<img
  src="/images/changelog/2025-07-30/models-tab.png"
  alt="External Models Manager interface showing the new location beside Pods"
...
<img
  src="/images/changelog/2025-07-30/upload-local-model.png"
  alt="Model upload interface showing drag-and-drop functionality and upload options"
  style={{ borderRadius: "8px"}}
/>
...
<AccordionGroup>
  <Accordion title="Search and Add from External Sources">
    ...
    <img
  src="/images/changelog/2025-07-30/search-models.png"
...
/>
  ...
  <Accordion title="Direct URL Downloads">
    ...
    various sources.
     ...
     <img
  src="/images/changelog/2025-07-30/upload-model-by-url.png"
...
<img
  src="/images/changelog/2025-07-30/move-workflow.png"
  alt="Move workflow modal interface showing folder selection"
  style={{ borderRadius: "8px" }}
/>
...
<img
  src="/images/changelog/2025-07-30/new-playground-ui.png"
  alt="Revamped Playground interface with enhanced functionality"
  style={{ borderRadius: "8px" }}
/>
