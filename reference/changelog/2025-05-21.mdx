...
<img
  src="/images/changelog/2025-05-21/comfyui_only_save_button.png"
  alt="Feature showing the only save button"
...
<AccordionGroup>
  <Accordion title="Merged Views">
    ...
    view for easier management
      <img
  src="/images/changelog\2025-05-21/comfyui_merged_views.png"
  alt="Merged views feature"
  style={{
    borderRadius: "8px",
    marginTop: "16px",
  }}
/>
  ...
  <Accordion title="Streamlined Editing">
    ...
    in one place
        <img
  src="/images/changelog/2025-05-21/comfyui_streamlined_editing.png"
  alt="enchanced editing options"  
  style={{
    borderRadius: "8px",
    marginTop: "16px",
  }}
/>
  ...
  <Accordion title="Smart Alerts">
    ...
    Settings
         <img
  src="/images/changelog/2025-05-21/comfyui-smart-alerts.png"
  alt="smart alerts"  
  style={{
    borderRadius: "8px",
    marginTop: "16px",
...
- Improved reliability when switching between platforms
  <img
  src="/images/changelog/2025-05-21/comfyui_enc_dec.png"
  alt="Added encode decode support"
  style={{ borderRadius: "8px"}}
  />
  <img
  src="/images/changelog/2025-05-21/comfyui_json_file.png"
