...
<Frame>
  <img
    src="/images/deploy/scaling-diagram.png"
    alt="Auto-scaling behavior showing queue depth, response time, and instance count over time"
  />
</Frame>
...
<Frame>
  <img
    src="/images/deploy/cost-scenarios.png"
    alt="Cost comparison across different usage patterns and optimization strategies"
  />
</Frame>
...
<Frame>
  <img
    src="/images/deploy/monitoring-dashboard.png"
    alt="Real-time monitoring dashboard showing performance metrics, costs, and alerts"
  />
</Frame>
