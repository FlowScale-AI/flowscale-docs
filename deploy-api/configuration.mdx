  ...
  <div style={{
    ...
    <div>
      <h4 style={{marginBottom: '1rem', color: '#495057'}}>
        [FLOWSCALE I/O NODES INTEGRATION PLACEHOLDER]
      </h4>
      <p style={{color: '#6c757d', maxWidth: '500px', lineHeight: '1.5'}}>
        Detailed ComfyUI workspace view showing proper integration of FlowScale I/O nodes within a complex workflow, highlighting connection patterns and configuration options.
      </p>
      <small style={{color: '#868e96', display: 'block', marginTop: '1rem'}}>
        Image Type: UI Screenshot | Context: Advanced I/O node integration patterns
      </small>
    </div>
  </div>
</Frame>
...
<Frame>
  <div style={{
    ...
    <div>
      <h4 style={{marginBottom: '1rem', color: '#495057'}}>
        [DEPLOY BUTTON LOCATION PLACEHOLDER]
      </h4>
      <p style={{color: '#6c757d', maxWidth: '450px', lineHeight: '1.5'}}>
        Application interface with deploy button location clearly marked and highlighted, showing contextual deployment options and readiness indicators.
      </p>
      <small style={{color: '#868e96', display: 'block', marginTop: '1rem'}}>
        Image Type: UI Screenshot | Context: Deployment initiation from configured workflow
      </small>
    </div>
  </div>
</Frame>
...
<Frame>
  <div style={{
    ...
    <div>
      ...
      <p style={{color: '#6c757d', maxWidth: '500px', lineHeight: '1.5'}}>
        Advanced pod selection interface showing detailed GPU specifications, pricing tiers, availability status, and performance recommendations for production deployments.
      </p>
      <small style={{color: '#868e96', display: 'block', marginTop: '1rem'}}>
        Image Type: UI Screenshot | Context: Production resource allocation and configuration
      </small>
    </div>
  </div>
</Frame>
