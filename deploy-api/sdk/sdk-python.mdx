---
title: "Python SDK"
description: "Transform your deployed ComfyUI workflows into powerful Python applications with production-ready integration and comprehensive features."
icon: "python"
---
...
<Tabs>
  <Tab title="Web Services (FastAPI/Django/Flask)">
  ...
  <Tab title="Data Processing & ML Pipelines">
    **Best for:** Jupyter notebooks, data science workflows, batch processing
    ...
    **Use cases:** Data analysis, model training pipelines, research projects
  </Tab>
  <Tab title="Automation & Scripting">
    **Best for:** Command-line tools, automation scripts, scheduled tasks
    ...
    **Use cases:** Content processing, automated workflows, system integration
  </Tab>
</Tabs>
