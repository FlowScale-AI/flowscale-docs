...
<Frame>
    <img src="/images/deploy-api/comfyui-playground-button.png" alt="API server management page with Open Playground button highlighted, showing workflow deployment status and playground access controls" />
</Frame>
...
<Frame>
    <img src="/images/deploy-api/comfyui-playground-UI.png" alt="Playground interface showing optimal two-column layout with input controls on left, output display on right, and clear visual separation between input and result areas" />
</Frame>
...
<Frame>
    <img src="/images/glossary/comfyui-api-runs.png" alt="Comprehensive playground interface showing all features - parameter controls, real-time generation, result gallery, sharing options, and usage analytics in a cohesive user experience" />
</Frame>
...
<Frame>
    ...
    <div>
      ...
      <p style={{color: '#6c757d', maxWidth: '550px', lineHeight: '1.5'}}>
        Step-by-step sequence showing complete playground workflow from input to output.
      </p>
      <small style={{color: '#868e96', display: 'block', marginTop: '1rem'}}>
        Image Type: UI Screenshot | Context: Complete playground user interface design
      </small>
...
<Frame>
    ...
    <div>
      ...
      <p style={{color: '#6c757d', maxWidth: '550px', lineHeight: '1.5'}}>
        Playground showing generation in progress with status indicators.
      </p>
      <small style={{color: '#868e96', display: 'block', marginTop: '1rem'}}>
        Image Type: UI Screenshot | Context: Complete playground user interface design
      </small>
