...
<Frame>
  <img
    src="/images/playground/api-server-open-playground.png"
    alt="API Server page with expanded workflow showing Open Playground button highlighted"
  />
</Frame>
...
<Frame>
  <img
    src="/images/playground/api-server-playground-access.png"
    alt="API Server page showing playground access point for deployed workflows"
  />
</Frame>
...
<Frame>
  <img
    src="/images/playground/playground-two-column-layout.png"
    alt="Complete playground interface showing two-column layout with input controls and output display"
  />
</Frame>
...
<Frame>
  <img
    src="/images/playground/playground-interface-detailed.png"
    alt="Detailed view of playground interface showing user-friendly workflow interaction"
  />
</Frame>
