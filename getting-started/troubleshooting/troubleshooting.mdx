...
<AccordionGroup>
  ...
  <Accordion title="Sharing workflows and projects with team members">
    ...
    **Project sharing**:
    ...
    - **Public sharing**: Share project links with external users
...
<AccordionGroup>
  ...
  <Accordion title="How do I manage deployment versions and rollbacks?">
    ...
    **Deployment versioning**:
    ...
    - Previous versions remain accessible by reverting a workflow to that specific checkpoint
  ...
  <Accordion title="Understanding usage costs and optimizing spending">
    ...
    **Cost optimization strategies**:
    - Use CPU mode for workflow editing
    - Choose appropriate GPU tiers: T4 or equivalent for simple, H100 or A100 or GPUs with higher VRAM for complex workflows
...
<AccordionGroup>
  ...
  <Accordion title="API key exposure warnings in browser applications">
    ...
    **Additional protections**:
    - Set pod budget quota in your Pod Settings
