...
<AccordionGroup>
  ...
  <Accordion title="What file formats can I import?">
    ...
    - **API JSON**: ComfyUI API format for advanced users  
  ...
  <Accordion title="How do I invite team members to my project?">
    ...
    **Role levels**:
    ...
    - **Contributor**: Can create and edit workflows
...
<AccordionGroup>
  ...
  <Accordion title="Workflow execution is very slow">
    ...
    **GPU selection**:
    - Use higher-tier GPUs (L4, A100) for complex workflows
    - T4 GPUs are suitable for simple workflows only
  ...
  <Accordion title="Out of memory errors">
    ...
    **GPU upgrade**:
    - Switch to a GPU with more VRAM (L4, A100, H100)
...
<AccordionGroup>
  ...
  <Accordion title="Gradio UI not loading or functioning properly">
    **UI troubleshooting**:
...
<AccordionGroup>
  <Accordion title="How is usage calculated and billed?">
    ...
    **Compute time**:
    ...
    - Different rates for T4, L4, A100, H100 GPUs
    - No charges when pods are idle

    **Storage**:
    - Model storage: $X per GB per month
    - Workflow storage: Included in base plan
    - Output storage: Temporary (24 hours) included

    **API calls**:
    - No additional charges for API requests
    - Only GPU compute time is billed

    **View usage**: Check your dashboard for real-time usage and cost tracking.
  </Accordion>
  ...
  <Accordion title="How do I upgrade my plan or add more resources?">
    **Plan management**:
    ...
    3. **Select "Change Plan"** or "Add Resources"
    4. **Choose your new plan** or resource allocation
