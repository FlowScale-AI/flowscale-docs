...
<CardGroup cols={2}>
  <Card title="ComfyUI Editor" icon="diagram-project">
...
The ComfyUI Editor is where you build and modify your AI workflows. It provides a visual node-based interface for creating complex AI pipelines.
...
<Steps>
  ...
  <Step title="Build Workflows">
    Use the ComfyUI Editor to create or import your AI workflows
  </Step>
