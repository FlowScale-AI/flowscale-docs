  ...
  <div style={{
    ...
    <div>
      <h4 style={{marginBottom: '1rem', color: '#495057'}}>
        [COMFYUI WORKSPACE OVERVIEW PLACEHOLDER]
      </h4>
      <p style={{color: '#6c757d', maxWidth: '600px', lineHeight: '1.5'}}>
        Comprehensive ComfyUI workspace interface showing all panels, tools, and workspace organization with clear labeling of key interface elements including project hub, creative canvas, and control center.
      </p>
      <small style={{color: '#868e96', display: 'block', marginTop: '1rem'}}>
        Image Type: UI Screenshot | Context: Complete workspace layout introduction
      </small>
    </div>
  </div>
</Frame>
...
<Frame>
  <div style={{
    ...
    <div>
      <h4 style={{marginBottom: '1rem', color: '#495057'}}>
        [COMFYUI STARTING DIALOG PLACEHOLDER]
      </h4>
      <p style={{color: '#6c757d', maxWidth: '500px', lineHeight: '1.5'}}>
        Initial startup dialog for ComfyUI workspace showing loading progress, initialization steps, and workspace preparation status.
      </p>
      <small style={{color: '#868e96', display: 'block', marginTop: '1rem'}}>
  ...
  <div style={{
    ...
    <div>
      ...
      <p style={{color: '#6c757d', maxWidth: '450px', lineHeight: '1.5'}}>
        Detailed view of ComfyUI control bar showing all available actions, tools, and workspace controls with clear iconography and organization.
      </p>
      <small style={{color: '#868e96', display: 'block', marginTop: '1rem'}}>
        Image Type: UI Screenshot | Context: Workspace control and action buttons
      </small>
    </div>
  </div>
</Frame>
...
Here's where FlowScale's cost-effectiveness shines. Start in **CPU mode** ($0.07/hour) for workflow building and editing, then switch to **GPU mode** only when you need to run actual generations. This approach can save your organization significant costs while maintaining full functionality.
...
<Frame>
  <div style={{
    ...
    <div>
      ...
      <p style={{color: '#6c757d', maxWidth: '450px', lineHeight: '1.5'}}>
        Interface for creating new workflows showing template options, starting configurations, and workflow initialization process.
      </p>
      <small style={{color: '#868e96', display: 'block', marginTop: '1rem'}}>
        Image Type: UI Screenshot | Context: Workflow creation starting point
      </small>
    </div>
  </div>
</Frame>
...
<Frame>
  <div style={{
    ...
    <div>
      <h4 style={{marginBottom: '1rem', color: '#495057'}}>
        [IMPORT WORKFLOW MODAL PLACEHOLDER]
      </h4>
      <p style={{color: '#6c757d', maxWidth: '450px', lineHeight: '1.5'}}>
        Workflow import dialog showing file selection, validation, and import configuration options with user guidance.
      </p>
      <small style={{color: '#868e96', display: 'block', marginTop: '1rem'}}>
        Image Type: UI Screenshot | Context: Workflow import process initiation
      </small>
    </div>
  </div>
</Frame>
...
<Frame>
  <div style={{
    ...
    <div>
      <h4 style={{marginBottom: '1rem', color: '#495057'}}>
        [WORKFLOW DEPENDENCIES PLACEHOLDER]
      </h4>
      <p style={{color: '#6c757d', maxWidth: '500px', lineHeight: '1.5'}}>
        Dependencies management interface showing required custom nodes, models, and configuration requirements for imported workflows.
      </p>
      <small style={{color: '#868e96', display: 'block', marginTop: '1rem'}}>
        Image Type: UI Screenshot | Context: Workflow dependency resolution and management
      </small>
    </div>
  </div>
</Frame>
...
<Frame>
  <div style={{
    ...
    <div>
      <h4 style={{marginBottom: '1rem', color: '#495057'}}>
        [ADD CUSTOM NODE DIALOG PLACEHOLDER]
      </h4>
      <p style={{color: '#6c757d', maxWidth: '500px', lineHeight: '1.5'}}>
        Interface for adding custom nodes showing node search, installation options, and dependency management tools.
      </p>
      <small style={{color: '#868e96', display: 'block', marginTop: '1rem'}}>
        Image Type: UI Screenshot | Context: Custom node installation and configuration
      </small>
    </div>
  </div>
</Frame>
