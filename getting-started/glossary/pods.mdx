...
<Tabs>
  <Tab title="General">
    <Frame>
      <img src="/images/build/gpu-settings.png" alt="General pod settings" />
    </Frame>
  ...
  <Tab title="GPU Settings">
    <Frame>
      <img src="/images/build/gpu-activity.png" alt="GPU settings configuration" />
    </Frame>
...
<AccordionGroup>
  ...
  <Accordion title="What's the difference between development and production pods?">
    **Development pods** have longer session persistence (up to 6 hours) and full ComfyUI editor interface. **Production pods** have fast cold-start optimization (< 30 seconds) and API-only interface.
  </Accordion>
</AccordionGroup>
