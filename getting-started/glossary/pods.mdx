...
<AccordionGroup>
  ...
  <Accordion title="Idle Timeout">
    Time a container waits after a generation before parking (→ $0.07/hr Upkeep fee only).
  </Accordion>
...
<CardGroup cols={2}>
  ...
  <Card title="A10G - 24GB VRAM" icon="microchip" color="#059669">
    **Best for:** Enhanced development, moderate workloads
    
    Cost-effective option with improved performance over T4
  </Card>
  ...
  <Card title="L40S - 48GB VRAM" icon="microchip" color="#2563eb">
    **Best for:** Advanced image/video generation, large models
    
    High-memory GPU for complex multi-modal workflows
  </Card>
  <Card title="A100 - 40GB VRAM" icon="microchip" color="#f59e0b">
    **Best for:** Complex workflows, large model training
    
    High-performance computing for demanding AI tasks
  </Card>
  <Card title="A100 - 80GB VRAM" icon="microchip" color="#ea580c">
    **Best for:** Massive models, extensive batch processing
    
    Maximum A100 memory for the largest workloads
  </Card>
  ...
  <Card title="H200 - 141GB VRAM" icon="microchip" color="#b91c1c">
    **Best for:** Massive models, extreme workloads
    
    Maximum memory capacity for the largest AI models
  </Card>
  <Card title="B200 - 180GB VRAM" icon="microchip" color="#7c2d12">
    **Best for:** Next-generation AI inference, cutting-edge models
    
    Latest architecture with massive memory for breakthrough AI performance
  </Card>
</CardGroup>
...
<AccordionGroup>
  ...
  <Accordion title="How do I monitor usage?">
    Go to **Pods › *Your Pod* › Deployment History** for per‑generation logs.
  </Accordion>
