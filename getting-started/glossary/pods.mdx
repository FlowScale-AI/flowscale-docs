      ...
      <div style={{
        ...
        <div>
          <h4 style={{marginBottom: '1rem', color: '#495057'}}>
            [GENERAL POD SETTINGS PLACEHOLDER]
          </h4>
          ...
          <small style={{color: '#868e96', display: 'block', marginTop: '1rem'}}>
            Image Type: UI Screenshot | Context: Pod resource configuration options
          </small>
        </div>
      </div>
    </Frame>
  ...
  <Tab title="GPU Settings">
    <Frame>
      <div style={{
        ...
        <div>
          <h4 style={{marginBottom: '1rem', color: '#495057'}}>
            [GPU SETTINGS CONFIGURATION PLACEHOLDER]
          </h4>
          <p style={{color: '#6c757d', maxWidth: '400px', lineHeight: '1.5'}}>
            Detailed GPU configuration panel showing hardware specifications, availability status, and performance optimization options.
          </p>
          <small style={{color: '#868e96', display: 'block', marginTop: '1rem'}}>
            Image Type: UI Screenshot | Context: Advanced GPU resource management
          </small>
        </div>
      </div>
    </Frame>
