  ...
  <div style={{
    ...
    <div>
      <h4 style={{marginBottom: '1rem', color: '#495057'}}>
        [COMFYUI TO API COMPARISON PLACEHOLDER]
      </h4>
      <p style={{color: '#6c757d', maxWidth: '600px', lineHeight: '1.5'}}>
        Split-screen comparison showing ComfyUI workflow interface on left with complex node network, and clean REST API endpoint documentation on right, connected by transformation arrows demonstrating the conversion process.
      </p>
      <small style={{color: '#868e96', display: 'block', marginTop: '1rem'}}>
        Image Type: Comparison Diagram | Context: ComfyUI to API transformation concept
      </small>
    </div>
  </div>
</Frame>
  ...
  <div style={{
    ...
    <div>
      ...
      <p style={{color: '#6c757d', maxWidth: '500px', lineHeight: '1.5'}}>
        Clean overview of ComfyUI workspace showing the visual programming interface with sample nodes, connections, and basic workflow structure. Emphasizes the drag-and-drop nature and node-based architecture.
      </p>
      <small style={{color: '#868e96', display: 'block', marginTop: '1rem'}}>
        Image Type: UI Screenshot | Context: Introduction to ComfyUI interface fundamentals
      </small>
    </div>
  </div>
</Frame>
...
<Frame>
  <div style={{
    ...
    <div>
      <h4 style={{marginBottom: '1rem', color: '#495057'}}>
        [MULTI-MODAL WORKFLOW PLACEHOLDER]
      </h4>
      <p style={{color: '#6c757d', maxWidth: '500px', lineHeight: '1.5'}}>
        ComfyUI workspace displaying a complex workflow that processes multiple data types (text, images, video, audio) with clearly labeled node chains showing data flow between different AI models and processing stages.
      </p>
      <small style={{color: '#868e96', display: 'block', marginTop: '1rem'}}>
        Image Type: UI Screenshot | Context: Advanced ComfyUI capabilities demonstration
      </small>
    </div>
  </div>
</Frame>
