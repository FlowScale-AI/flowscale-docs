...
<Frame>
    <img src="/images/glossary/comfyui_default_state.png" alt="Clean overview of ComfyUI workspace showing the visual programming interface with sample nodes, connections, and basic workflow structure. Emphasizes the drag-and-drop nature and node-based architecture" />
</Frame>
...
<Frame>
    <img src="/images/glossary/comfyui-workflow-example.png" alt="ComfyUI workspace showing multiple connected node chains for text, image, and video processing with clear data flow between AI models" />
</Frame>
