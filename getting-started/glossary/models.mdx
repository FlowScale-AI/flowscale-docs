...
<Frame>
  <img src="/images/glossary/models-overview.png" alt="FlowScale Models dashboard showing public and private model sections with folder structure similar to local ComfyUI setup" />
</Frame>
...
<Frame>
  <img src="/images/manage/models-tab-location.png" alt="Screenshot showing the Models tab location next to the Pods tab in FlowScale interface" />
</Frame>
...
<Frame>
  <img src="/images/build/create-model-folder-modal.png" alt="Dialog for creating a new model folder with dropdown showing standard ComfyUI folder options" />
</Frame>
...
<Frame>
  <img src="/images/build/model-upload-menu.png" alt="Three-dot menu on model folder showing upload option" />
</Frame>
...
<Frame>
  <img src="/images/build/model-upload-dialog.png" alt="Model upload dialog showing URL, file upload, and search options" />
</Frame>
...
<Frame>
  <img src="/images/build/api-key-setup.png" alt="API key configuration section in the upload dialog" />
</Frame>
...
<Frame>
  <img src="/images/build/model-upload-progress.png" alt="Model upload progress indicator and notification system" />
</Frame>
...
<Frame>
  <img src="/images/build/comfyui-refresh-button.png" alt="Refresh button location in ComfyUI actions bar" />
</Frame>
